<script setup>
import { Link, Button } from '@/Components/Dsfr'
...
<template>
  <div class="border">
    <div class="p-10">
      <img src="/images/icons/questions.svg" alt="" class="mb-4" />
      <h3 class="text-3xl mb-8 font-bold">Est-ce que c’est fait pour moi ?</h3>
