...
1. **Mettre à jour la présence des participants** directement sur [le site si tu ne l’as pas encore fait]({{ $url }})
...
3. **Partage la photo de groupe** et un retour d'expérience d'un(e) participant(e) sur [l'**espace de discussion dédié aux animateur(rice)s**](https://chat.whatsapp.com/JCGEYUlaLqSA3DW4vjnNoN).
